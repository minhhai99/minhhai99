...
public class Flower {
	...
	public Flower(int id, String name, int counter, int price, String picture, Timestamp date_create,
			String preview_text, String detail_text, Category category, TypeFlower typeFlower) {
		super();
		this.id = id;
		this.name = name;
		this.counter = counter;
