...
<div id="page-wrapper">
    <div id="page-inner">
       ...
       /*  @SuppressWarnings("unchecked")
        ...
        if(flower != null){
        	name = flower.getName();
        	price =  String.valueOf(flower.getPrice());
        	//catId = String.valueOf(flower.getCategory().getId());
        	typeId = String.valueOf(flower.getTypeFlower().getId());
        	preview = flower.getPreview_text();
        	detail = flower.getDetail_text();
                            ...
                            <div class="col-md-12">
                                <form action="" role="form" method="post" enctype="multipart/form-data" id="form">
                                    ...
                                    <%-- <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label for="category">Loại hoa</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        %>
                                        <br />
                                        <img width="276 px" height="357 px" alt="Ảnh" src="<%=request.getContextPath() %>/fileFlowers/<%=picture %>">
                                        <%} %>
                                    </div>
                                    <div class="form-group">
