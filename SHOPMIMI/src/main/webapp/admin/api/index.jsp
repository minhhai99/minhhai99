                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                %>
                                    <tr>
                                        ...
                                        %>
                                        <td class="center">
                                            <a href="<%=request.getContextPath() %>/admin/api/edit?id=<%=items.getId() %>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                            <a href="<%=request.getContextPath() %>/admin/api/del?id=<%=items.getId() %>" title="" class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn xoá!');"><i class="fa fa-pencil"></i> Xóa</a>
                                        </td>
                                        <%}else{ %>
                                        <td class="center">
